package com.robotane.hellonew.endpoint.event.model;

import static com.robotane.hellonew.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.robotane.hellonew.PojaGenerated;
import com.robotane.hellonew.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.robotane.hellonew.event1";
    return "com.robotane.hellonew.event2";
  }
}
