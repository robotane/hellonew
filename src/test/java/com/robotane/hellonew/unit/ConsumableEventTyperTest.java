package com.robotane.hellonew.unit;
...
import com.robotane.hellonew.conf.FacadeIT;
import com.robotane.hellonew.endpoint.event.consumer.model.ConsumableEvent;
import com.robotane.hellonew.endpoint.event.consumer.model.ConsumableEventTyper;
import com.robotane.hellonew.endpoint.event.consumer.model.TypedEvent;
import com.robotane.hellonew.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new TypedEvent("com.robotane.hellonew.endpoint.event.model.UuidCreated", payload);
